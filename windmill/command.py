...
class WindmillHTTPHandler(SimpleHTTPRequestHandler):
    def do_GET(self, *args, **kwargs):
        generate(self.windmill_config, self.windmill_base)
    ...
    def translate_path(self, path):
        ...
        path = os.path.join(self.windmill_base, 'static')
        for word in words:
...
def serve(config, base):
    ...
    WindmillHTTPHandler.windmill_base = base
    WindmillHTTPHandler.windmill_config = config
    httpd = HTTPServer(server_address, WindmillHTTPHandler)
